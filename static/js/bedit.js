...
//允许指定对象输入维吾尔文：attachAll = true;
//运输所有对象输入维吾尔文：bedit_allow="someone:somaelse" ;
//禁止指定对象输入维吾尔文：bedit_deny="someone:somaelse";

var U_I_E=false;// isimgha uyghurche kirguzushni cheklemsiz? 
attachAll = true;
bedit_allow="" ;
bedit_deny="equery:share_link:slink:seccodeverify:secanswer:price:readperm:email:qq:icq:yahoo:msn:site:alipay:taobao:bdaynew:sitenew:icqnew:qqnew:yahoonew:alipaynew:taobaonew:msnnew:emailnew:seccodeverify";
